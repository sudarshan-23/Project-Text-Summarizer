...
class ModelEvaluation:
    ...
    def calculate_metric_test_ds(self,dataset,metric,model,tokenizer,batch_size=16,device="cuda" if torch.cuda.is_available() else "cpu",
                             column_text = "article",
    ...
    def evaluate(self):
        ...
        score = self.calculate_metric_test_ds(
